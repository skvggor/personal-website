...
export default function ListeningCard({
  ...
  return (
    <div className="listening flex items-start gap-4 min-w-0 max-w-[300px] min-[1440px]:max-w-[400px] min-[2560px]:max-w-[14vw]">
      {/* Cover art — small, graphic */}
      <motion.div
        className="relative h-[56px] w-[56px] min-[2560px]:h-[2.4vw] min-[2560px]:w-[2.4vw] shrink-0 rounded-lg overflow-hidden"
      ...
      <div className="flex flex-col gap-0.5 min-w-0">
        <span className="flex items-center gap-1.5 text-poster-dark/70 text-[0.65rem] min-[2560px]:text-[0.5vw] font-bold uppercase tracking-[0.15em]">
          {isPlaying ? (
            <Disc
              size={12}
              weight="bold"
