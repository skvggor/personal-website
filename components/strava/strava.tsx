...
export default async function Strava({ type }: StravaProps) {
  ...
  return stravaContent.distance != null ? (
    <div className="sport flex items-center gap-2 min-[2560px]:gap-2">
      <Bicycle
        size={18}
        weight="bold"
        className="text-poster-dark/80 min-[2560px]:!h-[0.85vw] min-[2560px]:!w-[0.85vw]"
      />
      <span className="text-sm min-[2560px]:text-[0.7vw] font-bold text-poster-dark/70">
        <AnimatedNumber
